...
quite a clever mapping of Fibonacci to the sequences of numbers generated by
...
syntax feel cumbersome with more wrapping parens.) I guess I should change that
habit for now.
...
- Not all function can have fixed points, e.g. $f(x) = x+1$. In fact, there are
